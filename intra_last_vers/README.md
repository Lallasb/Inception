*This project has been created as part of the 42 curriculum by lasoubai.*
...
All three containers are connected through a dedicated Docker network, and persistent data (the WordPress database and the WordPress site files) is stored in two Docker named volumes, backed by bind mounts pointing at `/home/lasoubai/data/` on the host.
